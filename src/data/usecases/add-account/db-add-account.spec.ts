...
describe('DbAddAccount Usecase', () => {
  ...
  test('Ensure call AddDbAccountRepository with correct values', async () => {
  ...
  test('Ensure throw if AddAccountRepository throw', async () => {
    const { sut, addAccountRepositoryStub } = makeSut()
  ...
  test('Ensure return an account on success', async () => {
    const { sut } = makeSut()
    const accountData = {
      name: 'valid_name',
      email: 'valid_email',
